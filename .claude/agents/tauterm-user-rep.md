...
| Reviewing or writing acceptance criteria | `docs/fs/` — matching `FS-*` file (see `docs/fs/README.md`) |
| Validating a UX proposal | `docs/uxd/` — relevant component or section |
