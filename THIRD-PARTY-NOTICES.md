...
| aead | 0.6.0-rc.10 | MIT OR Apache-2.0 |
| aes | 0.8.4 | MIT OR Apache-2.0 |
| aes | 0.9.0 | MIT OR Apache-2.0 |
| aes-gcm | 0.10.3 | Apache-2.0 OR MIT |
| aes-gcm | 0.11.0-rc.3 | Apache-2.0 OR MIT |
...
| cpubits | 0.1.0 | MIT OR Apache-2.0 |
...
| internal-russh-forked-ssh-key | 0.6.18+upstream-0.6.7 | Apache-2.0 OR MIT |
...
| mio | 1.2.0 | MIT |
| ml-kem | 0.3.0-rc.2 | Apache-2.0 OR MIT |
| module-lattice | 0.2.1 | Apache-2.0 OR MIT |
...
| rustcrypto-ff | 0.14.0-rc.1 | MIT/Apache-2.0 |
| rustcrypto-group | 0.14.0-rc.1 | MIT/Apache-2.0 |
...
| scrypt | 0.12.0-rc.10 | MIT OR Apache-2.0 |
...
| signature | 3.0.0-rc.10 | Apache-2.0 OR MIT |
...
| @jest/diff-sequences | 30.3.0 | MIT |
| @jest/expect-utils | 30.3.0 | MIT |
| @jest/get-type | 30.1.0 | MIT |
| @jest/pattern | 30.0.1 | MIT |
| @jest/schemas | 30.0.5 | MIT |
| @jest/types | 30.3.0 | MIT |
...
| @wdio/cli | 9.27.0 | MIT |
| @wdio/config | 9.27.0 | MIT |
| @wdio/dot-reporter | 9.27.0 | MIT |
| @wdio/globals | 9.27.0 | MIT |
| @wdio/local-runner | 9.27.0 | MIT |
| @wdio/logger | 9.18.0 | MIT |
| @wdio/mocha-framework | 9.27.0 | MIT |
| @wdio/protocols | 9.27.0 | MIT |
| @wdio/repl | 9.16.2 | MIT |
| @wdio/reporter | 9.27.0 | MIT |
| @wdio/runner | 9.27.0 | MIT |
| @wdio/spec-reporter | 9.27.0 | MIT |
| @wdio/types | 9.27.0 | MIT |
| @wdio/utils | 9.27.0 | MIT |
| @wdio/xvfb | 9.27.0 | MIT |
...
| create-wdio | 9.27.0 | MIT |
| cross-spawn | 7.0.6 | MIT |
| css-select | 5.2.2 | BSD-2-Clause |
| css-shorthand-properties | 1.1.2 | MIT |
| css-tree | 3.2.1 | MIT |
| css-value | 0.0.1 | unknown |
...
| jest-diff | 30.3.0 | MIT |
| jest-matcher-utils | 30.3.0 | MIT |
| jest-message-util | 30.3.0 | MIT |
| jest-mock | 30.3.0 | MIT |
| jest-regex-util | 30.0.1 | MIT |
| jest-util | 30.3.0 | MIT |
| jiti | 2.6.1 | MIT |
...
| lines-and-columns | 2.0.4 | MIT |
| locate-app | 2.5.0 | Apache-2.0 |
...
| wait-port | 1.1.0 | MIT |
| wcwidth | 1.0.1 | MIT |
| webdriver | 9.27.0 | MIT |
| webdriverio | 9.27.0 | MIT |
