...
//! TypeScript counterparts are generated by `tauri-specta` — do not maintain
//! them by hand.
//!
//! Each event struct derives `tauri_specta::Event` and specifies its wire name
//! via `#[tauri_specta(event_name = "...")]`. Emission uses the typed
//! `event.emit(app)` API rather than raw `app.emit(name, payload)`.
...
#[tauri_specta(event_name = "session-state-changed")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "ssh-state-changed")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "screen-update")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "mode-state-changed")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "scroll-position-changed")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "credential-prompt")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "passphrase-prompt")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "host-key-prompt")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "cursor-style-changed")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "bell-triggered")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "osc52-write-requested")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "ssh-warning")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "ssh-reconnected")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "fullscreen-state-changed")]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, tauri_specta::Event)]
#[tauri_specta(event_name = "notification-changed")]
#[serde(rename_all = "camelCase")]
