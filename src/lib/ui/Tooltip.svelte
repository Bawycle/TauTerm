...
<Tooltip.Root {delayDuration}>
  ...
  <Tooltip.Content
    class="z-[60] px-2 py-1 text-[11px] text-(--color-text-primary) bg-(--color-bg-raised) border border-(--color-border) rounded-[4px] shadow-(--shadow-raised) max-w-[240px] pointer-events-none"
    sideOffset={4}
  >
    {content}
  </Tooltip.Content>
